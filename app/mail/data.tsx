...
export const accounts = [
  {
    label: "BCL Accounting",
    email: "accounts@bcl.com",
    type: "company",
    icon: (
    ...
    companies: [
      {
        ...
        email: "info@acme.com",
        contacts: [
          { name: "Alice Brown", email: "alice@acme.com", role: "CEO" },
          { name: "Bob Johnson", email: "bob@acme.com", role: "CFO" }
        ]
      },
      {
        name: "TechStart Inc",
        ...
        contacts: [
          { name: "Emma Davis", email: "emma@techstart.com", role: "Director" }
        ]
      }
    ]
  }

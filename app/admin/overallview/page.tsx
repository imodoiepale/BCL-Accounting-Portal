...
const OverallView: React.FC = () => {
        ...
        baseCompaniesResult.data.forEach(company => {
            ...
            Array.from(allTables).forEach(tableName => {
                ...
                const relatedRecords = tableData[tableName]?.filter(
                    record => record.company_name?.toLowerCase() === companyName
                );
  ...
  />
          ...
          <CompanyEditDialog
              ...
              onSave={(updatedData) => {
                  fetchAllData(selectedCompany?.activeMainTab, selectedCompany?.activeSubTab);
          ...
          <Dialog open={isMissingFieldsOpen} onOpenChange={setIsMissingFieldsOpen}>
              <DialogContent>
                  <MissingFieldsDialog
                      ...
                      onSave={(updatedData) => {
                          fetchAllData(selectedMissingFields?.activeMainTab, selectedMissingFields?.activeSubTab);

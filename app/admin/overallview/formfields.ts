export const formFields = {
    companyDetails: {
        fields: [
            ...
            { name: 'pin_certification_profile_download_dates', label: 'PIN Certification Profile Download Dates', type: 'date', category: 'Pin Details' },
            ...
            { name: 'income_tax_rent_income_effective_from', label: 'Income Tax Rent Income Effective From', type: 'date', category: 'Pin Details', subCategory: 'Income Tax - Rent Income' },
            { name: 'income_tax_rent_income_effective_to', label: 'Income Tax Rent Income Effective To', type: 'date', category: 'Pin Details', subCategory: 'Income Tax - Rent Income' },
            ...
            { name: 'income_tax_paye_effective_from', label: 'Income Tax PAYE Effective From', type: 'date', category: 'Pin Details', subCategory: 'Income Tax - PAYE' },
            { name: 'income_tax_paye_effective_to', label: 'Income Tax PAYE Effective To', type: 'date', category: 'Pin Details', subCategory: 'Income Tax - PAYE' },
            ...
            { name: 'income_tax_turnover_tax_effective_from', label: 'Income Tax Turnover Tax Effective From', type: 'date', category: 'Pin Details', subCategory: 'Income Tax TOT' },
            { name: 'income_tax_turnover_tax_effective_to', label: 'Income Tax Turnover Tax Effective To', type: 'date', category: 'Pin Details', subCategory: 'Income Tax TOT' },
